 ...
 */
public class ModelSearchAdapter extends BaseAdapter {
    LayoutInflater mInflater;
    List<ModelSearchData> mRowList;
    Context mContext;

    public ModelSearchAdapter(Context context, List<ModelSearchData> mRowList) {
        mContext = context;
    ...
    public View getView(int position, View convertView, ViewGroup viewGroup) {
        ...
        final ModelSearchData data = mRowList.get(position);
        if(convertView == null){
