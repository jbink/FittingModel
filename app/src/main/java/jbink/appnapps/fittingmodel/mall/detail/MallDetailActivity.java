package jbink.appnapps.fittingmodel.mall.detail;
...
public class MallDetailActivity extends AppCompatActivity{
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        mContext = MallDetailActivity.this;
    ...
    private void layoutBinding() {
        mPager = (ViewPager)findViewById(R.id.mall_shop_detail_pager);
        ...
        ((TextView)findViewById(R.id.mall_shop_detail_pager_tv_0)).setText(Html.fromHtml((getResources().getString(R.string.pager_txt_0))));
        ((TextView)findViewById(R.id.mall_shop_detail_pager_tv_1)).setText(Html.fromHtml(getResources().getString(R.string.pager_txt_1)));
        ((TextView)findViewById(R.id.mall_shop_detail_pager_tv_2)).setText(Html.fromHtml(getResources().getString(R.string.pager_txt_2)));
    ...
    public void onClick(View v){
        switch (v.getId()){
            case R.id.mall_shop_detail_btn_back :
                finish();
                break;
            case R.id.mall_shop_detail_btn_ok :
                notiDialog();
                break;
        }
    }
